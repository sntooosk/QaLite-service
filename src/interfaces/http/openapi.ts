    ...
    schemas: {
      TaskSummaryPayload: {
        ...
        properties: {
          message: {
            type: 'string',
            description: 'Mensagem enviada diretamente ao Slack (ignorando o resumo detalhado).',
          },
      ...
      EnvironmentSummaryPayload: {
        ...
        properties: {
          ...
          totalTime: { type: 'string', description: 'Tempo total em texto.', example: '00:15:30' },
          totalTimeMs: { type: 'integer', format: 'int64', description: 'Tempo total em milissegundos.' },
          ...
          suiteDetails: { type: 'string', description: 'Detalhes adicionais sobre a suíte.' },
